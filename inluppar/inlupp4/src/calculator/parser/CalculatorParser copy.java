...
//     private final ArrayList<String> allowedOperators = new ArrayList<String>(
//             Arrays.asList(
//                     "==",
//                     ">=",
//                     "<=",
...
//                 || this.st.ttype == this.st.TT_EOL || this.st.ttype == this.st.TT_EOF)) {
//             operator += (char) this.st.ttype;
//             this.st.nextToken();
//         }

//         if (!this.allowedOperators.contains(operator)) {
...
//         while (this.st.nextToken() != '}' && this.st.ttype != this.st.TT_EOF) {

//             //System.out.println((this.st.ttype == this.st.TT_WORD) ? "Word: " + this.st.sval : "Numbah: " + this.st.nval + ", char: " + ((char) this.st.nval)); 
            
            
            
//             //Function foo(n)
//             //If n == 1 {1} Else {foo(   (  (   n-1)))}
            
//             //När man läser en '(' vet man att det kommer en inparameter foo(n)
//             //n = expression();
//             //newCall.addArgument(expression());

//             //SymbolicExpression res = assignment();
//             //System.out.println(res.getClass());

//             newCall.addArgument(assignment());

//             /*
//             if (this.st.ttype == this.st.TT_WORD) {
//                 if (Constants.namedConstants.containsKey(this.st.sval)) {
//                     newCall.addArgument(new NamedConstant(this.st.sval, Constants.namedConstants.get(this.st.sval)));
//                 } else {
//                     newCall.addArgument(new Variable(this.st.sval));
//                 }
//             } else if (this.st.ttype == this.st.TT_NUMBER) {
//                 if (this.st.ttype == '(') {
                
//                     newCall.addArgument(primary());
//                 } else {
//                     newCall.addArgument(new Constant(this.st.nval));
//                 }
//             }*/
//         }
//         this.st.pushBack();
...
// //             System.out.println((this.st.ttype == this.st.TT_WORD) ? "Word: " + this.st.sval
// //                     : "Numbah: " + this.st.nval + ", char: " + ((char) this.st.nval));
...
// //             if (this.st.ttype == this.st.TT_WORD) {
// //                 if (Constants.namedConstants.containsKey(this.st.sval)) {
// //                     newCall.addArgument(new NamedConstant(this.st.sval,
// //                             Constants.namedConstants.get(this.st.sval)));
// //                 } else {
// //                     newCall.addArgument(new Variable(this.st.sval));
// //                 }
// //             } else if (this.st.ttype == this.st.TT_NUMBER) {
...
// //                                 * return new Constant(this.st.nval);
// //                                 * } else {
// //                                 * throw new SyntaxErrorException("Error: Expected number: " + ((this.st.ttype
// //                                 * == this.st.TT_WORD) ? "Word: " + this.st.sval : "Numbah: " + this.st.nval +
// //                                 * ", char: " + ((char) this.st.nval)));
// //                                 * }
// //                                 */
// //     }
// // }
...
// // // /**
// // // * Represents the parsing of strings into valid expressions defined in the
// // // AST.
// // // */
// // // public class CalculatorParser {
...
// // // * @throws IOException by nextToken() if it reads invalid input
// // // */
// // // public SymbolicExpression parse(String inputString, Environment vars,
// // // HashMap<String, FunctionDefinition> functions)
// // // throws IOException {
// // // this.st = new StreamTokenizer(new StringReader(inputString)); // reads from
// // // inputString via stringreader.
// // // this.vars = vars;
// // // this.functions = functions;
// // // this.st.ordinaryChar('-');
// // // this.st.ordinaryChar('/');
...
// // // if (this.st.ttype == this.st.TT_WORD) { // vilken typ det senaste tecken vi
// // // lÃ¤ste in hade.
// // // if (this.st.sval.equals("Quit") || this.st.sval.equals("Vars") ||
// // // this.st.sval.equals("Clear")) { // sval //
// // // // Variable
// // // result = command();
// // // }
// // // else if (this.st.sval.equals(FUNCTION)) {
...
// // // }
// // // else if (this.functions.containsKey(this.st.sval)) {
// // // result = functionCall(this.st.sval);
...
// // // }
// // // } else {
// // // result = assignment(); // om inte == word, gÃ¥ till assignment Ã¤ndÃ¥ (kan
// // // vara tt_number)
// // // }

// // // if (this.st.nextToken() != this.st.TT_EOF) { // token should be an end of
// // // stream token if we are done
// // // if (this.st.ttype == this.st.TT_WORD) {
// // // throw new SyntaxErrorException("Error: Unexpected '" + this.st.sval + "'");
// // // } else {
// // // // Här hamnar funktion som inte är definierad ... eller är definierad
// // // throw new SyntaxErrorException("Error: Unexpected '" + String.valueOf((char)
// // // this.st.ttype) + "'");
// // // }
// // // }
// // // return result;
...
// // // return new Conditional(leftIdentifier, operator, rightIdentifier, truthValue,
// // // falseValue);
// // // }
...
// // // this.st.nextToken();
// // // if (this.unallowedVars.contains(this.st.sval)) {
// // // throw new SyntaxErrorException("Error! Cannot redeclare function " +
// // // this.st.sval);
// // // }
...
// // // * invalid variable
// // // */
// // // private SymbolicExpression functionCall(String functionName) throws
// // // IOException {
// // // FunctionCall newCall = new FunctionCall(functionName);

// // // System.out.println("function call innan while");
// // // while (this.st.nextToken() != ')' && this.st.ttype != this.st.TT_EOF) {

// // // System.out.println((this.st.ttype == this.st.TT_WORD) ? "Word: " +
// // // this.st.sval : "Numbah: " + this.st.nval + ", char: " + ((char)
// // // this.st.nval));
...
// // // SymbolicExpression boy = assignment();
// // // System.out.println(boy);
// // // newCall.addArgument(boy);
...
// // // this.st.nextToken();
// // // if (this.st.ttype == this.st.TT_NUMBER) {
// // // throw new SyntaxErrorException("Error: Numbers cannot be used as a variable
// // // name");
// // // } else if (this.st.ttype != this.st.TT_WORD) {
// // // throw new SyntaxErrorException("Error: Not a valid assignment of a
// // // variable");
// // // } else {
// // // if (this.st.sval.equals("ans")) {
// // // throw new SyntaxErrorException("Error: ans cannot be redefined");
...
// // // * variable
// // // * @throws IOException by nextToken() if it reads invalid input
// // // * @throws IllegalExpressionException if you try to redefine a string that
// // // isn't
// // // * allowed
// // // */
// // // private SymbolicExpression identifier() throws IOException {
...
// // // if (this.unallowedVars.contains(this.st.sval)) {
// // // throw new IllegalExpressionException("Error: cannot redefine " +
// // // this.st.sval);
// // // }
...
// // // // result = functionCall(name); //new FunctionCall(name); // TODO: ändra till
// // // functionCall när den .. nån gång
// // // // } else {
// // // // // Bigboy be variabolz
